...
export const metadata: Metadata = {
  metadataBase: new URL("https://la-sazon-demo.com"),
  title: "La Sazón | Alta Cocina Peruana",
  description: "Donde el origen define la excelencia. Alta cocina de origen en Lima.",
  keywords: ["fine dining", "alta cocina", "tasting menu", "wine pairing", "Lima"],
  authors: [{ name: "La Sazón" }],
  creator: "La Sazón",
  publisher: "La Sazón",
  robots: { index: true, follow: true },
  openGraph: {
    type: "website", locale: "es_ES",
    url: "https://la-sazon-demo.com", siteName: "La Sazón",
    title: "La Sazón | Alta Cocina Peruana",
    description: "Donde el origen define la excelencia.",
    images: [{ url: "/images/interior.jpg", width: 1280, height: 720 }],
  },
  twitter: { card: "summary_large_image", title: "La Sazón | Alta Cocina Peruana", description: "Donde el origen define la excelencia." },
