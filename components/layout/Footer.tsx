      ...
      <div className="flex flex-col gap-xl px-margin-desktop py-xxl max-w-screen-2xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-xl">
          ...
          <div className="flex gap-lg flex-wrap">
            <a className="font-label-sm text-label-sm uppercase tracking-wider text-on-surface-variant hover:text-primary transition-all" href="#">Política de Privacidad</a>
            <a className="font-label-sm text-label-sm uppercase tracking-wider text-on-surface-variant hover:text-primary transition-all" href="#">Términos y Condiciones</a>
            <a className="font-label-sm text-label-sm uppercase tracking-wider text-on-surface-variant hover:text-primary transition-all" href="#">Accesibilidad AA</a>
          </div>
        </div>
