      ...
      <div className="px-margin-mobile md:px-margin-desktop py-xxl max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-xl">
          ...
          <div className="space-y-6">
            <div className="font-headline-md text-headline-md text-primary tracking-[0.2em]">AURA</div>
            <p className="font-body-md text-on-surface-variant max-w-xs leading-relaxed">
              Alta cocina de origen. Calle de la Memoria, 12. 28013 Madrid, España.
            </p>
            <div className="flex gap-md">
              <a className="w-10 h-10 border border-outline-variant/20 flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary transition-all" href="https://instagram.com/aura.restaurant" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <span className="material-symbols-outlined text-lg" aria-hidden="true">public</span>
              </a>
              <a className="w-10 h-10 border border-outline-variant/20 flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary transition-all" href="https://facebook.com/aurarestaurant" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <span className="material-symbols-outlined text-lg" aria-hidden="true">groups</span>
              </a>
              <a className="w-10 h-10 border border-outline-variant/20 flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary transition-all" href="https://wa.me/34912345678" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 font-body-md text-on-surface-variant">
              ...
              <a href="mailto:reservas@aura-restaurant.com" className="hover:text-primary transition-colors">reservas@aura-restaurant.com</a>
              <a href="mailto:eventos@aura-restaurant.com" className="hover:text-primary transition-colors">eventos@aura-restaurant.com</a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-md border-t border-outline-variant/10 pt-xl mt-xl">
          <p className="font-label-sm text-label-sm text-on-surface-variant">&copy; {new Date().getFullYear()} AURA. Todos los derechos reservados.</p>
