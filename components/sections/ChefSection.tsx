  ...
  return (
    <section className="py-xxl px-margin-desktop max-w-screen-2xl mx-auto" id="chef">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-xxl items-center">
        <div className="md:order-2 order-1 reveal relative h-[700px] overflow-hidden">
        ...
        <div className="md:order-1 order-2 reveal space-y-8 px-lg">
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="primary" size="md" href="/reservas">Experience His Cuisine</Button>
            <Button variant="ghost" size="md" href="#philosophy">Read Philosophy</Button>
          </div>
        </div>
      </div>
    </section>
