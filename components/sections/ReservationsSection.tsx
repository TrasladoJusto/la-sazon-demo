...
<form className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
           ...
           <div className="col-span-full space-y-2">
             ...
             <textarea className="w-full bg-transparent border-b border-outline-variant focus:border-primary transition-colors text-on-surface font-body-md py-2 focus:ring-0 placeholder:text-outline-variant" placeholder="Alergias o solicitudes especiales..." rows={3} data-icon="document" data-alt="special preferences"></textarea>
           </div>
<button className="col-span-full bg-primary-container text-on-primary-container py-5 font-label-sm text-label-sm uppercase tracking-[0.2em] hover:bg-primary transition-all duration-500 mt-8" data-icon="check" data-alt="confirm reservation" type="submit">
             Confirmar reserva
           </button>
         </form>
         <div className="mt-8 text-center">
           <a className="flex items-center justify-center gap-2 text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#" data-icon="chat" data-alt="WhatsApp">
